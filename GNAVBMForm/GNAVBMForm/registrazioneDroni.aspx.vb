...
Imports GNAVBMForm.AreaCorsi20.CompilaModuloPdf20
Public Class registrazioneDroni
    ...
    '    txtprov.Text = prov.FirstOrDefault().ToString()
    'End Sub
    ...
    Protected Sub btn_registra_Click(sender As Object, e As ImageClickEventArgs) Handles btn_registra.Click
        ...
        Dim form_reg As registrazioneDroni
        ...
        Dim gestionerecapito As New GestioneRecapito20()
        ...
        Dim Gestioneutente As New GestioneUtente20
        ...
        Dim gest_profile As New GestioneProfilo20()
        ...
        gest_profile.luogonascita = Me.listacomuni_ctl.Text
        gest_profile.provnascita = Me.txtprov.Text
        gest_profile.Indirizzo = Me.txt_indirizzo.Value
        gest_profile.civico = Me.txt_civico.Value
        gest_profile.Città_residenza = Me.listacity_ctl.Text
        ...
        Dim gestdoc_identità As New GestioneDocIdentità20()
        ...
        Dim gestpag As New GestionePagamentoCorso20()
        ...
        Dim compila As New AreaCorsi20.CompilaModuloPdf20("DRONI", Page, form_reg)
    ...
    Private Sub SI_CheckedChanged(sender As Object, e As EventArgs) Handles SI.CheckedChanged
        ...
        Dim test1 As Boolean = Me.listacity_ctl.Text = "Seleziona comune"

        test = Me.txt_cognome.Value = "" Or txt_nome.Value = "" Or txt_datanascita.Value = "" Or
                  Me.listacomuni_ctl.Text = "" Or txt_indirizzo.Value = "" Or txt_civico.Value = "" _
                  Or Me.txt_codicefiscale.Value = "" Or Me.listatipodocumento.SelectedValue = "Tipo documento" Or
                    ...
                    Me.enterilascio.SelectedValue = "Ente Rilascio" Or Me.luogorilascio.Text = "" _
                    Or Me.txtmobilenumber.Value = "" Or Me.txtemail.Value = "" Or Me.txttitolostudio.Value = "" Or
                    Me.user_id_corsista.Value = "" Or Me.pwd_corsista.Value = "" Or
                    Me.Modalità1.Checked = False Or Me.Modalità2.Checked = False Or Me.Modalità3.Checked = False Or
                    Me.gna.Checked = False Or matricola.Value = ""
        ...
        End If
        If (Me.listacomuni_ctl.Text = "") Then
            Me.errore_successo.InnerHtml = Me.errore_successo.InnerHtml & "<li>Comune di nascita obbligatorio</li>"
        End If
        ...
        End If
        If (Me.listacity_ctl.Text = "Seleziona comune") Then
        ...
        If (Me.user_id_corsista.Value = "" And gna.Checked = False) Then
            Me.errore_successo.InnerHtml = Me.errore_successo.InnerHtml & "<li>User Id Corsista obbligatoria</li>"
        End If
        If (Me.pwd_corsista.Value = "" And gna.Checked = False) Then
            Me.errore_successo.InnerHtml = Me.errore_successo.InnerHtml & "<li>Password Corsista obbligatoria</li>"
        End If
        If (Me.gna.Checked = True And matricola.Value = "") Then
            Me.errore_successo.InnerHtml = Me.errore_successo.InnerHtml & "<li>Matricola Obbligatoria</li>"
        End If
        If (Me.Modalità1.Checked = False And Me.Modalità2.Checked = False And Me.Modalità3.Checked = False) Then
            Me.errore_successo.InnerHtml = Me.errore_successo.InnerHtml & "<li>Modalità di pagamento obbligatoria</li>"
        End If
        ...
        test = Me.txt_cognome.Value = "" Or txt_nome.Value = "" Or txt_datanascita.Value = "" Or
                 Me.listacity_ctl.Text = "" Or txt_indirizzo.Value = "" Or txt_civico.Value = "" _
                 Or Me.txt_codicefiscale.Value = "" Or Me.listatipodocumento.SelectedValue = "Tipo documento" Or
                   Me.txt_numerodoc.Value = "" Or Me.data_rilascio.Value = "" Or Me.data_scadenza.Value = "" Or
                   Me.enterilascio.SelectedValue = "Ente Rilascio" Or Me.luogorilascio.Text = "" _
                   Or Me.txtmobilenumber.Value = "" Or Me.txtemail.Value = "" Or Me.txttitolostudio.Value = "" Or
                   Me.user_id_corsista.Value = "" Or Me.pwd_corsista.Value = ""
    ...
    Protected Sub listacomuni_ctl_TextChanged(sender As Object, e As EventArgs) Handles listacomuni_ctl.TextChanged
        json = System.IO.File.ReadAllText(Server.MapPath("comuni/comuni.json"))

        LISTACOMUNI = JsonConvert.DeserializeObject(Of List(Of Comuni))(json)

        Dim City_selezionata As String = listacomuni_ctl.Text
        Dim prov = From provincia In LISTACOMUNI
                   Where provincia.Nome = City_selezionata
                   Select provincia.Sigla

        txtprov.Text = prov.FirstOrDefault()

        txt_indirizzo.Focus()
    End Sub

    Protected Sub listacity_ctl_TextChanged(sender As Object, e As EventArgs)
        json = System.IO.File.ReadAllText(Server.MapPath("comuni/comuni.json"))

        LISTACOMUNI = JsonConvert.DeserializeObject(Of List(Of Comuni))(json)

        Dim city_comune_res As String = listacity_ctl.Text
