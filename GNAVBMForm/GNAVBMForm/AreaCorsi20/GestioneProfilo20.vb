...
Public Class GestioneProfilo20
    ...
    Public Sub SalvaProfiloUtente(mysqlconn As MySqlConnection, mysqlcomm As MySqlCommand, gestutente As GestioneUtente20, stringaconn_gna As String, stringaconn_corsi As String, freg As registrazioneDroni)
