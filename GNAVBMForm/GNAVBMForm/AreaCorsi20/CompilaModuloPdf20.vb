...
Namespace AreaCorsi20
    Public Class CompilaModuloPdf20


        Public Sub New(nomemodulo As String, PageWebForm As Page, formreg As registrazioneDroni)
        ...
        Private Sub ExecuteCompilaModuloDroni(nomemodulo As String, page_webform As Page, freg As registrazioneDroni)
            ...
            For Each elencocampi In dizionario_campi
                ...
                If (elencocampi = "Data di nascita") Then
                    ...
                    ELENCO_CAMPI.SetField(elencocampi, data_testo)
                End If
                If (elencocampi = "Luogo di nascita") Then
                    ELENCO_CAMPI.SetField(elencocampi, freg.listacomuni_ctl.Text)
                End If
                ...
                If (elencocampi = "Città") Then
                    ELENCO_CAMPI.SetField(elencocampi, freg.listacity_ctl.Text)
                End If
                ...
                If (elencocampi = "Data rilascio") Then
                    ...
                    If (mese <= 9) Then
                        mese = "0" & LTrim(Str(mese))
                    End If
                    Dim data_testo = giorno.ToString() & "/" & mese.ToString() & "/" & data.Year.ToString()
                    ELENCO_CAMPI.SetField(elencocampi, data_testo)
                End If
