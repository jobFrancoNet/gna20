...
Public Class ins_ric
    Inherits System.Web.UI.Page
    Public id_matr As Integer
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        id_matr = Request("matr")
        Response.Write("GESTIONE RICONOSCIMENTI PER IL SOCIO CON MATRICOLA " & id_matr)
        ...
        attiv = Request.Cookies("SITOGNA")("cogn") & " " & Request.Cookies("SITOGNA")("nome") & " ha effettuato l'accesso alla pagina riconoscimenti per il socio " & id_matr
