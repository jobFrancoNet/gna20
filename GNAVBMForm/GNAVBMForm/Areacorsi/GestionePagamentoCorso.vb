...
Namespace AreaCorsi
    Public Class GestionePagamentoCorso
        ...
        Public Function OttieniIdModalitàPagamento(freg As registrazionecorso, mysqlconn As MySqlConnection, mysqlcomm As MySqlCommand) As Integer
