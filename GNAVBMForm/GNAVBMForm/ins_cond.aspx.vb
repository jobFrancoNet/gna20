...
Public Class ins_cond
    Inherits System.Web.UI.Page
    Public id_matr As String
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        id_matr = Request("matr")
        Response.Write("GESTIONE CONDANNE PER IL SOCIO CON MATRICOLA " & id_matr)
        ...
        attiv = Request.Cookies("SITOGNA")("cogn") & " " & Request.Cookies("SITOGNA")("nome") & " ha effettuato l'accesso alla pagina delle condanne per il socio " & Request.QueryString("matr")
