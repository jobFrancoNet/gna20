<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="registrazioneDroni.aspx.vb" Inherits="GNAVBMForm.registrazioneDroni" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
		$(document).ready(function () {
			...
			$('<%=String.Format("#{0}", listacomuni_ctl.ClientID) %>').autocomplete({
            ...
            $('<%=String.Format("#{0}", listacity_ctl.ClientID) %>').autocomplete({
            source: function(request, response) {
                $.ajax({
                    url: "WebLoadComune.asmx/LoadComuniFromJson",
                    data: "{ 'pattern': '" + request.term + "' }",
            ...
            minLength: 1    // MINIMUM 1 CHARACTER TO START WITH.
             ...
             $('<%=String.Format("#{0}", luogorilascio.ClientID) %>').autocomplete({
            source: function(request, response) {
                $.ajax({
                    url: "WebLoadComune.asmx/LoadComuniFromJson",
                    data: "{ 'pattern': '" + request.term + "' }",
    ...
    <table border="1" style="width:auto">
       ...
       <tr>
        ...
        <tr>
          ...
          <tr>
           ...
           <td style="width:99%; background-color: #00FFCC;">
               <asp:TextBox runat="server" AutoPostBack="true" Text=""   ID="listacomuni_ctl" OnTextChanged="listacomuni_ctl_TextChanged" Width="100%" />
               <%--asp:DropDownList ID="listacomuni_ctl" runat="server" AutoPostBack="True" OnSelectedIndexChanged="listacomuni_ctl_SelectedIndexChanged">
       ...
       <tr>
           ...
           <td style="width:99%">
               <asp:Label BackColor="aquamarine" ForeColor="Black" EnableViewState="true" runat="server" ID="txtprov" />
               <%--<input  style="background-color:aquamarine;color:black;" readonly="true" type="text"  id="txt_prov" runat="server" />--%></td>
      </tr>
       ...
       <tr>
        ...
        <tr>
           ...
           <td style="width:99%; background-color: #00FFCC;"><%--<asp:DropDownList ID="listacity_ctl" runat="server" AutoPostBack="True">
                 <asp:ListItem>City</asp:ListItem></asp:DropDownList>--%>
                 <asp:TextBox runat="server" ID="listacity_ctl" Text="" AutoPostBack="true" OnTextChanged="listacity_ctl_TextChanged" Width="100%" />
               </td>
       </tr>
        <tr>
       ...
       <tr>
        ...
        <tr>
           <td style="width:264px"><b>Ente di rilascio*</b></td>
           <td style="width:99%"><asp:DropDownList ID="enterilascio" runat="server" AutoPostBack="True">
               ...
               <asp:Label ID="Label1"  runat="server" Text="Luogo di rilascio*:"></asp:Label>
               
               <asp:TextBox runat="server" BackColor="Aquamarine" ForeColor="Black" ID="luogorilascio" Text="" AutoPostBack="true" BorderWidth="3px" />
