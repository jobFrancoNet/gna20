<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="contenuto_moduloA1.aspx.vb" Inherits="GNAVBMForm.contenuto_moduloA1" %>
...
<body>
    <form id="form1" runat="server">
        <div class="auto-style4">
            ...
            <br />
             <asp:ImageButton ID="btn_registrati" runat="server" ImageUrl="/img/pulsante-registrati.png" OnClientClick="javascript:caricamoduloreg(1);" />
        </div>
    </form>
</body>
</html>
